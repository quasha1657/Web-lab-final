        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                if (isset($_SESSION['email'])){ ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="7_random_numbers.php">Problem No. 7</a>
                    </li>
                    <li class="nav-item">
...
<div class="container text-dark font-weight-bold p-5">
    <h3>Write a PHP script to generate unique random numbers within a range.</h3>
    <br>
    <br>
    <?php
    $rangeNumber=range(11,20);
    shuffle($rangeNumber);
    for ($i=0; $i< 10; $i++)
    {
        echo $rangeNumber[$i].' ';
