        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                if (isset($_SESSION['email'])){ ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="1_insert_display_data.php">Problem No. 1</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="col-md-6 justify-content-center">
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="add_user_one.php" method="post">
                        <div class="text-center">
                            <h3 class="text-uppercase text-dark">Add new user</h3>
                        </div>
