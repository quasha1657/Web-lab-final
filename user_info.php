    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                ...
                if (isset($_SESSION['email'])){ ?>
                    <li class="nav-item">
                        <a class="nav-link active" href="user_info.php">User Info</a>
                    </li>
                    <li class="nav-item">
            ...
            if($result = $conn -> query($sql)) {
                ...
                while ($row = $result -> fetch_row()) {  ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn bg-warning" href="edit_user.php?id=<?php echo $row['0'];?>">Edit</a>
                            <a class="btn bg-danger" href="delete_user.php?id=<?php echo $row['0'];?>">Delete</a>
                        </td>
                    </tr>
                <?php }
            } ?>
